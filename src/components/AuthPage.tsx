...
export function AuthPage({ onSuccess, onBack, initialTab = 'signup' }: AuthPageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isSignup && phone && !validatePhone(phone)) newErrors.phone = 'Enter a valid phone';
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      const input = form.querySelector(`[name="${firstErrorKey}"]`) as HTMLInputElement | null;
      input?.focus();
      return;
    }
  ...
  const handleForgotPassword = async () => {
    const emailInput = loginFormRef.current?.elements.namedItem('email') as HTMLInputElement | null;
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-3xl">Welcome to wasel</CardTitle>
          ...
          <CardContent>
            <Tabs defaultValue={initialTab} className="w-full">
              ...
              <TabsContent value="signup">
                <form ref={signupFormRef} onSubmit={handleSubmit} data-mode="signup" className="mt-4 space-y-4" aria-live="polite">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="signup-first-name">First Name</Label>
                      <Input id="signup-first-name" name="first_name" placeholder="First name" required autoComplete="given-name" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="signup-last-name">Last Name</Label>
                      <Input id="signup-last-name" name="last_name" placeholder="Last name" required autoComplete="family-name" />
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2">
                    <input type="checkbox" id="signup-terms" className="mt-1" required />
                    <label htmlFor="signup-terms" className="text-sm text-gray-600">
                      I agree to kassel's Terms of Service and Privacy Policy
                    </label>
                  </div>
              ...
              <TabsContent value="login">
                <form ref={loginFormRef} onSubmit={handleSubmit} data-mode="login" className="mt-4 space-y-4" aria-live="polite">
                  <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <label htmlFor="login-remember" className="text-sm text-gray-600">Remember me</label>
                  </div>
